...
// 이건 그 축약형이라 같은 화면에 둘 다 나오면 안 된다.
//
// (2026-09-08) `/churches`는 처음엔 제외했다 — h1이 사이트명이라 이름이 두 번
// 나왔기 때문이다. **그 중복은 증상이었고 원인은 h1이었다.** h1을 `교회 찾기`로
// 고쳐 문서 제목·breadcrumb와 이름을 맞춘 뒤 이 화면에도 넣었다.
