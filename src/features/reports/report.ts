 ...
 *
 * **순서는 대상 기준이다** — 앞의 둘은 이미 실린 교회에 대한 것이고,
 * `교회 추가 요청`은 아직 없는 교회에 대한 것이다. `기타`는 항상 맨 뒤에 둔다.
 *
 * **`교회 추가 요청`을 넣은 이유** (2026-09-09). 수록 범위가 좁은 개혁주의라
 * 자기 교회가 빠진 것을 발견하는 사람이 나온다. 창구가 없으면 `기타`로 들어와
