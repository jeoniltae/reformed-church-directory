...
개혁신앙을 명확히 표방하는 교단과 독립개혁교회를 다룹니다 — 예장 고신·합신, 독립개신교회, 독립개혁장로회, 개혁교회 계열 등. **한국 개신교 전체를 담는 디렉토리가 아니며, 여기 없는 교회가 개혁주의가 아니라는 뜻도 아닙니다.** 범위에 맞는데 빠진 교회는 아래 제보 창구에서 추가 요청을 받습니다.
...
${link("정보 수정·삭제·교회 추가 요청", "/report", "로그인 없이 보낼 수 있는 제보 창구")}
